/* Autogenerated RPL Token program C Bindings */
...
typedef enum Token_TokenInstruction_Tag {
     ...
     * will be equal to the amount of RENEC in the account. If this account is
     ...
     * amounts of RENEC and Tokens will be transferred to the destination
     * account.
     *
     * Accounts expected by this instruction:
     *
    ...
    /**
     * Close an account by transferring all its RENEC to the destination account.
    ...
    /**
     * Given a wrapped / native token account (a token account containing RENEC)
     * updates its amount field based on the account's underlying `lamports`.
     * This is useful if a non-wrapped RENEC account uses `system_instruction::transfer`
...
typedef struct Token_Account {
     ...
     * RENEC accounts do not drop below this threshold.
     */
